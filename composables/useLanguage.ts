export const useLanguage = () => {
  ...
  const translations = {
    pt: {
      ...
      'about.paragraph2': 'Sou movido pela curiosidade e pelo desafio de transformar problemas complexos em soluções técnicas elegantes. Tenho prazer em trabalhar com sistemas escaláveis de backend, arquiteturas em nuvem e ferramentas de automação que aumentam a confiabilidade dos produtos. Aprendizado contínuo, código limpo e trabalho em equipe colaborativo são os valores fundamentais que guiam minha mentalidade de engenharia.',
      'about.yearsCount': '3+',
      'about.yearsLabel': 'Anos',
      'about.projectsCount': '20+',
      'about.projectsLabel': 'Projetos',
      ...
      'projects.project1.title': 'Rehab.AI',
      'projects.project1.name': 'Aplicação utilizando arquitetura de microsserviços e orientada a eventos',
      'projects.project1.description': 'Plataforma de reabilitação assistida por IA que utiliza processamento de linguagem natural para criar planos de tratamento personalizados.',
      'projects.project2.title': 'Notification',
      'projects.project2.name': 'Microsserviço de Notificações',
      'projects.project2.description': 'Microsserviço de notificações escalável para envio de e-mails e SMS, utilizando mensageria e serviços AWS.',
    ...
    en: {
      ...
      'about.paragraph2': 'Driven by curiosity and the challenge of transforming complex problems into elegant technical solutions. I enjoy working on scalable backend systems, cloud-based architectures, and automation tools that enhance product reliability. Continuous learning, clean code, and collaborative teamwork are the core values that guide my engineering mindset.',
      'about.yearsCount': '3+',
      ...
      'projects.project1.title': 'Rehab.AI',
      'projects.project1.name': 'Application using microservices and event-driven architecture',
      'projects.project1.description': 'Platform for AI-assisted rehabilitation that uses natural language processing to create personalized treatment plans.',
      'projects.project2.title': 'Notification Service',
      'projects.project2.name': 'Notification Service',
      'projects.project2.description': 'Scalable notification microservice for sending emails and SMS, using messaging and AWS services.',
      'projects.project3.title': 'Authentication Service',
